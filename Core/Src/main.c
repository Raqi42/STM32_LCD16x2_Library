...
int main(void)
{
  ...
  LCD_SetCursor(0, 5);			//First row
  LCD_SendStr("Sly Fox");
  LCD_SetCursor(1, 3);			// second row
  LCD_SendStr("Electronics");
  /* USER CODE END 2 */
...
//-------shift the whole display to the left---------------
void LCD_Roll()
{
	//---Rolling Block--------------------
